/*!
 * \file Alash_DS1302.cpp
 * \brief DS1302 RTC library for Arduino
 * \details
 *      Source:         https://github.com/Alash/Alash_DS1302
 *      Documentation:  https://Alash.github.io/Alash_DS1302
 */
 ...
 */
Alash_DS1302::Alash_DS1302(uint8_t clkPin, uint8_t ioPin, uint8_t cePin)
{
#ifdef __AVR
 ...
 */
bool Alash_DS1302::clockEnable(bool enable)
{
    uint8_t regSeconds;
 ...
 *      Set epoch failed.
 */
bool Alash_DS1302::setEpoch(time_t t)
{
    struct tm *dt;
 ...
 *      Read failed.
 */
bool Alash_DS1302::read(struct tm *dt)
{
 ...
 *      Write failed.
 */
bool Alash_DS1302::write(const struct tm *dt)
{
 ...
 *      Set time failed.
 */
bool Alash_DS1302::setTime(uint8_t hour, uint8_t min, uint8_t sec)
{
    struct tm dt;
 ...
 */
bool Alash_DS1302::getTime(uint8_t *hour, uint8_t *min, uint8_t *sec)
{
    struct tm dt;
 ...
 */
bool Alash_DS1302::setDateTime(uint8_t hour, uint8_t min, uint8_t sec,
 ...
 */
bool Alash_DS1302::getDateTime(uint8_t *hour, uint8_t *min, uint8_t *sec,
                               uint8_t *mday, uint8_t *mon, uint16_t *year,
                               uint8_t *wday)
{
    struct tm dt;
 ...
 *      RAM byte 0..0xFF
 */
void Alash_DS1302::writeByteRAM(uint8_t addr, uint8_t value)
{
    transferBegin();
 ...
 */
void Alash_DS1302::writeBufferRAM(uint8_t *buf, uint8_t len)
{
    transferBegin();
 ...
 *      RAM byte 0..0xFF
 */
uint8_t Alash_DS1302::readByteRAM(uint8_t addr)
{
    uint8_t value;
 ...
 *      Buffer length
 */
void Alash_DS1302::readBufferRAM(uint8_t *buf, uint8_t len)
{
    transferBegin();
 ...
 *      Decimal value.
 */
uint8_t Alash_DS1302::bcdToDec(uint8_t bcd)
{
 ...
 *      BCD encoded value.
 */
uint8_t Alash_DS1302::decToBcd(uint8_t dec)
{
 ...
 */
uint8_t Alash_DS1302::readRegister(uint8_t reg)
{
    uint8_t value = 0;
 ...
 */
bool Alash_DS1302::writeRegister(uint8_t reg, uint8_t value)
{
 ...
 *      Write failed.
 */
bool Alash_DS1302::writeBuffer(uint8_t reg, void *buffer, uint8_t writeLen)
{
 ...
 *      Read failed.
 */
bool Alash_DS1302::readBuffer(uint8_t reg, void *buffer, uint8_t readLen)
{
    if (reg != 0) {
 ...
 */
void Alash_DS1302::transferBegin()
{
    DS1302_CLK_LOW();
    DS1302_IO_LOW();
    DS1302_IO_OUTPUT();
 ...
 */
void Alash_DS1302::writeAddrCmd(uint8_t value)
{
    // Write 8 bits to RTC
 ...
 *      Data byte
 */
void Alash_DS1302::writeByte(uint8_t value)
{
    // Write 8 bits to RTC
    for (uint8_t i = 0; i < 8; i++) {
        if (value & 0x01) {
